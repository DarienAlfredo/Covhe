...
class Game {
    ...
    showWelcome() {
        Swal.fire("Bienvenido", `Tetris en CovHe 😉
<br>
...
<li class="list-group-item"><strong>Realmente leeran esto o solo lo quitaran?🤔</strong></li>
</ul>
<strong>Gracias por usar <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">CovHe</a></strong>
<br>
Gracias a el equipo de Devsoft por todo el trabajo puesto,
 gracias a mi mamá por la vida y a Chayane por las ganas de vivirla 💪🤑🤙
`);
    }
